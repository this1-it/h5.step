...
/**
 * @param {Array.<function>|...function} steps
 * @throws {Error} If any of the specified step functions throws.
 * @throws {Error} If two actions were used in one step.
 */
function step()
{
  ...
  function nextStep()
  {
    ...
    handleActionResult(resultAction, resultActionArgs);
  }

  function handleActionResult(resultAction, resultActionArgs)
  {
    switch (resultAction)
    {
      case ACTION_NEXT:
